...
public enum PlayerAction {
        ...
        WALKING(0,32,25,29,8,30, 0.25),
        JUMPING(0,62,19,30,1,30, 0.25),
        FALLING(0,94,30,30,2,30, 0.25),
        GLIDING(getGlidingFrames(), 0.25),
        FIREBALLING(getFireBallAttackFrames(), 0.3),
        SCRATCHING(getScratchingAttackFrames(), 0.3);
        ...
        private PlayerAction(List<Rectangle> frames, double speed){
